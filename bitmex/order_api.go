 ...
 * @return *Order
 */
func (a OrderApi) OrderNew(symbol string, side string, simpleOrderQty float64, quantity float32, orderQty float64, price float64, displayQty float32, stopPrice float64, stopPx float64, clOrdID string, clOrdLinkID string, pegOffsetValue float64, pegPriceType string, type_ string, ordType string, timeInForce string, execInst string, contingencyType string, text string) (*Order, *APIResponse, error) {
	...
	formParams["simpleOrderQty"] = fmt.Sprintf("%f", simpleOrderQty)
...
func (a OrderApi) OrderCreate(symbol, side, ordType string, orderQty, price float64) (*Order, *APIResponse, error) {
